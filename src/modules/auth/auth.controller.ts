...
export class AuthController implements IController {
  ...
  private signInWithOauth: RequestHandler = async (req, res) => {
    ...
    if (existingAccessToken) {
      ...
      if (payload) {
        return res.ok(null, { message: "Already signed in" });
      }
    }
  ...
  private signUp: RequestHandler<unknown, unknown, SignUpBody> = async (
    ...
    res.created(user, { message: "User signed up successfully" });
  };
  ...
  private signOut: RequestHandler = async (req, res) => {
    ...
    if (!refreshToken) {
      return res.ok(null, { message: "Already signed out" });
    }
  ...
  private verifyOTP: RequestHandler<unknown, unknown, VerifyOTPBody> = async (
    ...
    res.ok(null, { message: "OTP verified" });
  };
  ...
  > = async (req, res) => {
    ...
    res.ok(null, { message: "Magic link sent" });
  };
  ...
  > = async (req, res) => {
    ...
    res.ok(null, { message: "Magic link verified" });
  };
  ...
  > = async (req, res) => {
    ...
    res.ok(null, { message: "Email verification sent" });
  };
  ...
  private forgetPassword: RequestHandler<unknown, unknown, ForgetPasswordBody> =
    async (req, res) => {
      ...
      res.ok(null, { message: "Password reset link sent" });
    };
